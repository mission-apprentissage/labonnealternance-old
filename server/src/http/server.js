...
module.exports = async (components) => {
  ...
  // expressServer.get('/pages/:id', (req, res) => {
  //   const params = route('/pages/:id')(parse(req.url).pathname);
  //   return nextApp.render(req, res, '/pages', params);
  // });

  // expressServer.get('*', (req, res) => {
  //   // nextApp.render(req, res, '/pages/home', {});
