...
httpTests(__filename, ({ startServer }) => {
  ...
  it("Vérifie que la recherche répond", async () => {
    ...
    const response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=30&insee=75056"
    );
  ...
  it("Vérifie que les requêtes avec ROME mal formé sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=ABCDE&longitude=2.3752&latitude=48.845&radius=30&insee=75056"
    );
  ...
  it("Vérifie que les requêtes avec radius mal formé sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=XX&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec radius hors limite sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=201&insee=12345"
    );
  ...
  it("Vérifie que les requêtes sans latitude sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec latitude mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=AX&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec latitude hors limites sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=91&insee=12345"
    );
  ...
  it("Vérifie que les requêtes sans longitude sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=&latitude=2.3752&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec longitude mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=AX&latitude=2.3752&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec longitude hors limites sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=181&latitude=90&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec sources mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobs?romes=F1603,I1308&radius=0&longitude=180&latitude=90&insee=12345&sources=lba,lbc"
    );
    ...
    assert.ok(
      response.data.error_messages.indexOf(
        "sources : Optional sources argument used with wrong value. Should contains comma separated values among 'lbb', 'lba', 'offres'."
      ) >= 0
    );
  });
  ...
  it("Vérifie que les requêtes avec rome inconnu retournent bien une erreur explicite pour les appels lbb et lba", async () => {
    ...
    let response = await httpClient.get("/api/V1/jobs?romes=X0000&radius=0&longitude=180&latitude=90&insee=12345");
