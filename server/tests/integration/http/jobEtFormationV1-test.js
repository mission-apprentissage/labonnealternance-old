...
httpTests(__filename, ({ startServer }) => {
  ...
  it("Vérifie que les requêtes sans ROME sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=&longitude=2.3752&latitude=48.845&radius=30&insee=75056"
    );
  ...
  it("Vérifie que les requêtes avec ROME mal formé sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=ABCDE&longitude=2.3752&latitude=48.845&radius=30&insee=75056"
    );
  ...
  it("Vérifie que les requêtes avec trop de ROME sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=ABCDE,ABCDE,ABCDE,ABCDE,ABCDE,ABCDE,ABCDE,ABCDE,ABCDE,ABCDE,&longitude=2.3752&latitude=48.845&radius=30&insee=75056"
    );
  ...
  it("Vérifie que les requêtes sans code insee sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=30&insee="
    );
  ...
  it("Vérifie que les requêtes avec code insee mal formé sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=30&insee=ABCDE"
    );

    assert.strictEqual(response.status, 400);
    assert.deepStrictEqual(response.data.error, "wrong_parameters");
    assert.ok(
      response.data.error_messages.indexOf("insee : Badly formatted insee city code. Must be 5 digit number.") >= 0
    );
  });
  ...
  it("Vérifie que les requêtes sans radius sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec radius mal formé sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=XX&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec radius hors limite sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=201&insee=12345"
    );
  ...
  it("Vérifie que les requêtes sans latitude sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec latitude mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=AX&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec latitude hors limites sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=91&insee=12345"
    );

    assert.strictEqual(response.status, 400);
    assert.deepStrictEqual(response.data.error, "wrong_parameters");
    assert.ok(
      response.data.error_messages.indexOf("latitude : Search center latitude must be a number between -90 and 90.") >=
        0
    );
  });
  ...
  it("Vérifie que les requêtes sans longitude sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=&latitude=2.3752&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec longitude mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=AX&latitude=2.3752&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec longitude hors limites sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=181&latitude=90&insee=12345"
    );
    ...
    assert.ok(
      response.data.error_messages.indexOf(
        "longitude : Search center longitude must be a number between -180 and 180."
      ) >= 0
    );
  });
  ...
  it("Vérifie que les requêtes avec sources mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=180&latitude=90&insee=12345&sources=lba,lbc"
    );
  ...
  it("Vérifie que les requêtes avec diploma mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/jobsEtFormations?romes=F1603,I1308&radius=0&longitude=180&latitude=90&diploma=lba,lbc"
    );
