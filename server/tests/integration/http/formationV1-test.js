...
httpTests(__filename, ({ startServer }) => {
  ...
  it("Vérifie que les requêtes sans ROME et sans domaine ROME sont refusées", async () => {
    ...
    assert.ok(
      response.data.error_messages.indexOf(
        "romes, romeDomain : You must define at least 1 rome code OR a single romeDomain."
      ) >= 0
    );
  });
  ...
  it("Vérifie que les requêtes avec ROME et domaine ROME sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&romeDomain=A20&longitude=2.3752&latitude=48.845&radius=30"
    );
  ...
  it("Vérifie que les requêtes avec radius mal formé sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=XX&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec radius hors limite sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&longitude=2.3752&latitude=48.845&radius=201&insee=12345"
    );
  ...
  it("Vérifie que les requêtes sans latitude sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec latitude mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=AX&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec latitude hors limites sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=2.3752&latitude=91&insee=12345"
    );
  ...
  it("Vérifie que les requêtes sans longitude sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=&latitude=2.3752&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec longitude mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=AX&latitude=2.3752&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec longitude hors limites sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=181&latitude=90&insee=12345"
    );
  ...
  it("Vérifie que les requêtes avec diploma mal formée sont refusées", async () => {
    ...
    let response = await httpClient.get(
      "/api/V1/formations?romes=F1603,I1308&radius=0&longitude=180&latitude=90&diploma=lba,lbc"
    );
