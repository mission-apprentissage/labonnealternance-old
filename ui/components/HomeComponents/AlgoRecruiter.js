    ...
    <section className="c-algo container pl-5 py-4 mb-4">
      <div className="">
        ...
        <ul className="c-algo-text">
          <li><strong>Celles ayant émis un besoin en recrutement </strong>sur notre plateforme ainsi que sur Pôle emploi et ses sites partenaires</li>
          <li className="pt-3"><strong>Celles n'ayant pas diffusé d'offres, mais ayant été identifiées comme "à fort potentiel d'embauche en alternance"</strong> par un algorithme prédictif de Pôle emploi, qui analyse les recrutements des 6 années passées en CDI, CDD de plus de 30 jours et alternance. L’objectif de cet algorithme est de rendre accessible le marché caché de l’emploi, et ainsi faciliter les démarches de candidatures spontanées des usagers du service.</li>
        </ul>
      </div>
