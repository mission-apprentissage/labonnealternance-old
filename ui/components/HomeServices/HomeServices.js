  ...
  return (
    <section className="c-home-services">
      ...
      <div className="card-deck c-home-services__container">
        ...
        <HomeCard logo={logoSirius} kind="sirius" title='Sirius' text="Avis et témoignages d'apprentis" />
        <HomeCard logo={logoMatcha} kind="matcha" title='Matcha' text="Service bientôt disponible" />
        <HomeCard logo={logoCatalogue} kind="catalog" title='Catalogue des formations' text="Un catalogue élargi de formations en apprentissage" />
