        ...
        <div className="row">
          ...
          <div className="col-12 col-md-7">
            ...
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                La Bonne Alternance ne propose pas d’offres d’emploi. Nous ciblons spécifiquement les entreprises ayant
                un fort potentiel d’embauche et vous mettons à disposition une liste par métier. Vous devez utiliser
                cette liste dans le cadre de candidatures spontanées. En effet, 75 % des recrutements ne sont jamais
                diffusés.
              </p>
            </div>
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                La Bonne Alternance vous indique uniquement les entreprises à fort potentiel d’embauche en fonction du
                métier sélectionné. Le tri par secteurs d’activité est donc uniquement possible sur les secteurs
                d’activité de ces entreprises. La recherche par secteur d’activité n’est actuellement pas disponible.
              </p>
            </div>
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                ...
                merci de nous contacter par l’intermédiaire du formulaire "Donner votre avis" (à droite de l’écran).
              </p>
            </div>
            <div className="c-faq-question-block">
              <h2 className="c-faq-question">
                J’ai indiqué un métier précis, et les entreprises présentées ne correspondent pas à mes attentes.
              </h2>
              <p className="c-faq-answer">
                La Bonne Alternance est bien plus qu’un simple annuaire. La Bonne Alternance effectue un ciblage
                spécifique des entreprises à fort potentiel d’embauche afin de vous faire gagner du temps dans la
            ...
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                La Bonne Alternance utilise le Répertoire Opérationnel des Métiers et des Emplois (ROME). Seuls les
                métiers et appellations présents dans ce répertoire sont disponibles.
              </p>
            </div>
            <div className="c-faq-question-block">
              <h2 className="c-faq-question">Il n’y a pas de précisions sur les profils recherchés.</h2>
              <p className="c-faq-answer">
                La Bonne Alternance vous indique uniquement les entreprises à fort potentiel d’embauche. Il n’y a donc
                pas d’offres d’emploi. Il s’agit d’entreprises ciblées auprès desquelles vous pouvez envoyer des
            ...
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                La Bonne Alternance vous indique uniquement les coordonnées portées à notre connaissance par les
                entreprises.
              </p>
            </div>
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                La Bonne Alternance vous indique uniquement les coordonnées portées à notre connaissance par les
                entreprises. La mise à jour des coordonnées est également réalisée par les entreprises qui peuvent
                omettre de nous prévenir.
              </p>
            </div>
            <div className="c-faq-question-block">
            ...
            <div className="c-faq-question-block">
              ...
              <p className="c-faq-answer">
                Laissez un message en cliquant sur "Donner votre avis" à droite de l’écran.
              </p>
            </div>
          </div>
        </div>
