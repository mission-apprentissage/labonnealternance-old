    ...
    <div className="c-page-container container my-0 mb-sm-5 p-5">
      <div className="row">
        ...
        <div className="col-12 col-md-7">
          ...
          <a href="https://github.com/mission-apprentissage/labonnealternance">LBA - Recherche d'une formation et/ou d'un organisme de formation en apprentissage</a>
          ...
          <a href="https://api.gouv.fr/les-api/api-la-bonne-alternance">https://api.gouv.fr/les-api/api-la-bonne-alternance</a>
        </div>
      </div>
    </div>
